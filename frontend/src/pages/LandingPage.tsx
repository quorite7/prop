        ...
        <Container maxWidth="lg">
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="body2" sx={{ mb: 2, opacity: 0.8 }}>
                Professional home improvement project management for UK homeowners and builders.
              </Typography>
          ...
          >
            <Typography variant="body2" sx={{ opacity: 0.6 }}>
              © 2025 UK Home Improvement Platform. All rights reserved. | Platform provides document preparation and introduction services only.
            </Typography>
          </Box>
        </Container>
      </Box>
